...
export default function Locatie() {
  return (
    <>
      <div className="flex justify-center text-4xl " data-swiper-parallax="-200">
        <p className="font-bold text-white mb-10 text-center">Where memories are made </p>
      </div>
      <div className="grid md:grid-cols-4 place-items-center md:mx-5">
        <div className="md:pl-4 md:col-span-1 flex justify-center">
        </div>
